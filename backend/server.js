...
/*Api to search by pid with pagination*/
...
app.get("/get-product", (req, res) => {
  try {
    ...
    if (req.query && req.query.search) {
      query["$and"].push({
        pid: { $regex: req.query.search }
      });
    }
    var perPage = 5;
    var page = req.query.page || 1;
    product.find(query, { date: 1, name: 1, id: 1, desc: 1, price: 1, pid: 1, image: 1 })
